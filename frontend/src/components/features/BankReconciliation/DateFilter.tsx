...
type DateFilterProps = {
    ...
    onChange?: (val: { fromDate: string, toDate: string }) => void
}

const DateFilter = ({ value: propValue, onChange }: DateFilterProps) => {
    ...
    // ✅ controlled / uncontrolled fix
    const bankRecDate = propValue ?? internalDate
    const setBankRecDate = onChange ?? setInternalDate
